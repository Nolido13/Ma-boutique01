...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip Mobile - au toucher, disparaît après 2 secondes */}
      {isMobile && showTooltip && (
        <span className="absolute right-full mr-3 bg-primary-dark text-white text-xs font-medium py-1.5 px-3 rounded-lg whitespace-nowrap shadow-lg animate-fadeIn">
          Nous contacter
        </span>
      )}
    </a>
